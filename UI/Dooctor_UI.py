...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ResultImage = QtWidgets.QGraphicsView(self.centralwidget)
        self.ResultImage.setGeometry(QtCore.QRect(290, 120, 171, 192))
        self.ResultImage.setObjectName("ResultImage")
        self.OriginalImage_cropped = QtWidgets.QGraphicsView(self.centralwidget)
        self.OriginalImage_cropped.setGeometry(QtCore.QRect(90, 350, 111, 101))
        self.OriginalImage_cropped.setObjectName("OriginalImage_cropped")
        ...
        self.OriginalImage = QtWidgets.QGraphicsView(self.centralwidget)
        self.OriginalImage.setGeometry(QtCore.QRect(80, 110, 171, 192))
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.NoBrush)
        self.OriginalImage.setBackgroundBrush(brush)
